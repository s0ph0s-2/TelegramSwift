...
//        #endif
    ...
    private func launchInterface() {
        ...
        let sharedWakeupManager = SharedWakeupManager(sharedContext: sharedContext, inForeground: presentAccountStatus.get())
        ...
        sharedContextPromise.set(accountManager.transaction { transaction -> (SharedApplicationContext, LoggingSettings) in
